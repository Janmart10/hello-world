...
import json
import rospy
from nav_msgs.msg import Odometry #added this
...
class CarlaEgoVehicle(object):
    ...
    def setup_sensors(self, sensors):
        ...
        :return:
        """
        print("SETUP SENSORS")#Added this
        actors = []
        ...
        for sensor_spec in sensors:
            try:
                ...
                if sensor_spec['type'].startswith('sensor.camera'):
                    ...
                    #ADDED THIS TO PRINT LIDAR PARAMETERS
                    print('\n' * 5)
                    print("LIDAR RANGE IS ")
                    print(sensor_spec['range'])
                    print("ROTATION FREQUENCY IS ")
                    print(sensor_spec['rotation_frequency'])
                    print("channels is ")
                    print(sensor_spec['channels'])
                    print("upper_fov is ")
                    print(sensor_spec['upper_fov'])
                    print("lower_fov is ")
                    print(sensor_spec['lower_fov'])
                    print("points per second is ")
                    print(sensor_spec['points_per_second'])
